...
public class Main {
    public static void main(String[] args) throws Exception {
        @Cleanup Window window = Window.create(800, 800, "");
    ...
    public static Texture createTestTexture() throws Exception {
        int size = 64;
    ...
    public static VertexArray createVaoFromGeometry(IGeometry geometry) throws Exception {
        VertexArray vertexArray = VertexArray.create();
        VertexBuffer vertexBuffer = VertexBuffer.create();
        IndexBuffer indexBuffer = IndexBuffer.create();
        ...
        vertexBuffer.setData(geometry.getVertices(), BufferUsage.STATIC_DRAW);
        indexBuffer.setData(geometry.getIndices(), BufferUsage.STATIC_DRAW);
